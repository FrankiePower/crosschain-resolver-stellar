...
export const networks = {
  testnet: {
    ...
    contractId: "CBY2HYKT4A66AR4RGCWILHDDSOT2DU7LHZ32IQD4GGET6X6EMPPQ4FYA",
  }
} as const
 ...
 */
export type DataKey = {tag: "Timelocks", values: void};
...
export type DataKey = {tag: "AddressMap", values: void} | {tag: "ImmutablesData", values: void};
