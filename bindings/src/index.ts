...
export const networks = {
  testnet: {
    ...
    contractId: "CB4HX4W6HEJ73YDKUTN2Y4IFCRDUNMBIVUYUBEASUEC5UDPA775SLKEZ",
  }
} as const
...
/**
 * Storage key for all data types
 */
export type DataKey = 
  | {tag: "Timelocks", values: void}
  | {tag: "AddressMap", values: void} 
  | {tag: "ImmutablesData", values: void}
  | {tag: "RescueDelay", values: void} 
  | {tag: "Factory", values: void} 
  | {tag: "Immutables", values: void};
